...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\pic16f18325.h"
...
void pwm_init(void)
{
{INTCONbits.GIE = 0; PPSLOCK = 0x55; PPSLOCK = 0xAA; PPSLOCKbits.PPSLOCKED = 0; INTCONbits.GIE = 1;}
RC3PPS = 0b01100;
{INTCONbits.GIE = 0;PPSLOCK = 0x55; PPSLOCK = 0xAA; PPSLOCKbits.PPSLOCKED = 1; INTCONbits.GIE = 1;}


PR2 = 0xFF;
T2CONbits.T2CKPS = PWM_PRESCALER_4;
